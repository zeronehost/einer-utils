...
assert.strictEqual(
  utils.camelUpperToLower("CamelUpperToLower"),
  "camelUpperToLower"
);
assert.strictEqual(
  utils.camelLowerToUpper("camelLowerToUpper"),
  "CamelLowerToUpper"
);
...
assert.strictEqual(
  utils.lineToCamel("camel-to-line", "-", true),
  "CamelToLine"
);
assert.strictEqual(utils.lineToCamel("camel_to_line", "_"), "camelToLine");
assert.strictEqual(
  utils.lineToCamel("camel_to_line", "_", true),
  "CamelToLine"
);
